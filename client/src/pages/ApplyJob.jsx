        ...
        <div className='bg-white text-black rounded-lg w-full'>
          <div className='flex justify-center md:justify-between flex-wrap gap-8 px-14 py-20 mb-6 bg-sky-50 border border-sky-400 rounded-xl'>
            ...
            <div className='flex flex-col justify-center text-end text-sm max-md:mx-auto max-md:text-center'>
              <button onClick={applyHandler} className='bg-[#0EA5E9] text-black p-2.5 px-10 rounded cursor-pointer'>{isAlreadyApplied ? ' Already Applied' : 'Apply Now'}</button>
          ...
          <div className='flex flex-col lg:flex-row justify-between items-start gap-8'>
            <div className='w-full lg:w-2/3'>
              ...
              <button onClick={applyHandler} className='bg-[#0EA5E9] text-black p-2.5 px-10 rounded mt-10 cursor-pointer'>{isAlreadyApplied ? ' Already Applied' : 'Apply Now'}</button>
            </div>
