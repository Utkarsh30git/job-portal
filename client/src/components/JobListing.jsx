...
const JobListing = () => {
  ...
  useEffect(() => {
    ...
    const matchesLocationFilter = (job) =>
  ...
  return (
    <div className="container 2xl:px-20 mx-auto flex flex-col lg:flex-row ">
      {/* SideBar  */}
      <div className="w-full lg:w-1/4 px-4 bg-white mb-8 ">
          ...
          (searchFilter.title !== "" || searchFilter.location !== "") && (
            <>
              ...
              <div className="mb-4 text-gray-600">
                ...
                {searchFilter.location && (
                  <span className="ml-2 inline-flex items-center gap-2 bg-red-50 border border-red-200 px-4 py-1.5 rounded">
                    {searchFilter.location}
                    <img
                      onClick={(e) =>
      ...
      <section className="w-full lg:w-3/4 max-lg:px-4 text-gray-800">
        ...
        <p className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
        ...
        {filteredJobs.length > 0 && (
          <div className="flex items-center justify-center space-x-2 mt-10 mb-5">
            <a href="#job-list">
              <img
